...
cmd:option('-endAt', 50, 'end image id')
...
print('| loading model file in evalPerImage... ' .. config.model)
...
print(string.format('| saving results in %s',savedir))
