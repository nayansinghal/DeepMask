...
print('| loading model file in patch...' .. config.model)
...
log = log..string.format(
  ...
  'iou@.5 %06.2f iou@.6 %06.2f iou@.7 %06.2f iou@.8 %06.2f iou@.9 %06.2f iou@1.0 %06.2f',
  maskmeter.n,config.batch*config.testmaxload/sys.toc(),
  maskmeter:value('mean'),maskmeter:value('median'),
  maskmeter:value('0.5'), maskmeter:value('0.6'), maskmeter:value('0.7'), maskmeter:value('0.8'), maskmeter:value('0.9'), maskmeter:value('1.0')
  )
print(log)
